...
-- Database: `group2ddl`
--
CREATE DATABASE IF NOT EXISTS `group2ddl` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `group2ddl`;
...
('root', '[{\"db\":\"group2ddl\",\"table\":\"tbl_orders\"}]');
...
('root', '2025-04-10 11:41:31', '{\"Console\\/Mode\":\"collapse\"}');
